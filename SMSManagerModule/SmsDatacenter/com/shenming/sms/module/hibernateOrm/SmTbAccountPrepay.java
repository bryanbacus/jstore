...
/**
 * The persistent class for the sm_tb_account_prepay database table.
 * 
 * @author BEA Workshop Studio
 */
public class SmTbAccountPrepay extends com.shenming.sms.base.bean.BaseBean implements Serializable {
	...
	public int getPrepayed() {
		return this.prepayed;
	}
	public void setPrepayed(int prepayed) {
