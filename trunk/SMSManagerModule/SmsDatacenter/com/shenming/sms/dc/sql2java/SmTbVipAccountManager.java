...
/**
 * Handles database calls for the sm_tb_vip_account table.
 */
public class SmTbVipAccountManager
// extends+ 
...
// extends- 
{
    ...
    private static final String TABLE_NAME = "sm_tb_vip_account";

    /**
     * Create an array of type string containing all the fields of the sm_tb_vip_account table.
     */
    private static final String[] FIELD_NAMES =
    {
        "sm_tb_vip_account.sm_vip_seq"
        ,"sm_tb_vip_account.vip_cht_name"
        ,"sm_tb_vip_account.vip_eng_name"
        ,"sm_tb_vip_account.birthday"
        ,"sm_tb_vip_account.sex"
        ,"sm_tb_vip_account.blood"
        ,"sm_tb_vip_account.marrage"
        ,"sm_tb_vip_account.address"
        ,"sm_tb_vip_account.phone"
        ,"sm_tb_vip_account.mobile"
        ,"sm_tb_vip_account.mail_addr"
        ,"sm_tb_vip_account.fovarite"
        ,"sm_tb_vip_account.job"
        ,"sm_tb_vip_account.cr_date"
        ,"sm_tb_vip_account.buy_sum"
        ,"sm_tb_vip_account.is_valid_vip"
        ,"sm_tb_vip_account.username"
        ,"sm_tb_vip_account.password"
        ,"sm_tb_vip_account.error_cnt"
        ,"sm_tb_vip_account.owner"
    };

    /**
     * Field that contains the comma separated fields of the sm_tb_vip_account table.
     */
    private static final String ALL_FIELDS = "sm_tb_vip_account.sm_vip_seq"
                            + ",sm_tb_vip_account.vip_cht_name"
                            + ",sm_tb_vip_account.vip_eng_name"
                            + ",sm_tb_vip_account.birthday"
                            + ",sm_tb_vip_account.sex"
    ...
    private static SmTbVipAccountManager singleton = new SmTbVipAccountManager();

    /**
     * Get the SmTbVipAccountManager singleton.
     *
     * @return SmTbVipAccountManager
     */
    synchronized public static SmTbVipAccountManager getInstance()
    {
        return singleton;
    }

    /**
     * Sets your own SmTbVipAccountManager instance.
     <br>
     * This is optional, by default we provide it for you.
     */
    synchronized public static void setInstance(SmTbVipAccountManager instance)
    {
        singleton = instance;
    }
    ...
    /**
     * Creates a new SmTbVipAccountBean instance.
     *
     * @return the new SmTbVipAccountBean
     */
    public SmTbVipAccountBean createSmTbVipAccountBean()
    {
        return new SmTbVipAccountBean();
    }
    ...
    /**
     * Loads a SmTbVipAccountBean from the sm_tb_vip_account using its key fields.
     *
     * @return a unique SmTbVipAccountBean
     */
    //12
    public SmTbVipAccountBean loadByPrimaryKey(Long smVipSeq) throws SQLException
    {
        Connection c = null;
        ...
        {
            c = getConnection();
            ps = c.prepareStatement("SELECT " + ALL_FIELDS + " FROM sm_tb_vip_account WHERE sm_tb_vip_account.sm_vip_seq=?",ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            Manager.setLong(ps, 1, smVipSeq);
            SmTbVipAccountBean pReturn[] = loadByPreparedStatement(ps);
            if (pReturn.length < 1)
                return null;
            else
                return pReturn[0];
     ...
     */
    //60
    public int deleteByPrimaryKey(Long smVipSeq) throws SQLException
    {
        Connection c = null;
        PreparedStatement ps = null;
        try
        {
            c = getConnection();
            ps = c.prepareStatement("DELETE from sm_tb_vip_account WHERE sm_tb_vip_account.sm_vip_seq=?",ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            Manager.setLong(ps, 1, smVipSeq);
    ...
    /**
     * Loads all the rows from sm_tb_vip_account.
     *
     * @return an array of SmTbVipAccountManager pObject
     */
    //38
    public SmTbVipAccountBean[] loadAll() throws SQLException
    {
        return loadAll(1, -1);
    }
    ...
    /**
     * Loads the given number of rows from sm_tb_vip_account, given the start row.
     *
     ...
     */
    //38.5
    public SmTbVipAccountBean[] loadAll(int startRow, int numRows) throws SQLException
    {
        Connection c = null;
        PreparedStatement ps = null;
        try
        {
            c = getConnection();
            ps = c.prepareStatement("SELECT " + ALL_FIELDS + " FROM sm_tb_vip_account",ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    //////////////////////////////////////
    /**
     * Retrieves an array of SmTbVipAccountBean given a sql 'where' clause.
     *
     * @param where the sql 'where' clause
     * @return the resulting SmTbVipAccountBean table
     */
    //49
    public SmTbVipAccountBean[] loadByWhere(String where) throws SQLException
    {
        return loadByWhere(where, null);
    }

    /**
     * Retrieves an array of SmTbVipAccountBean given a sql where clause, and a list of fields.
     ...
     */
    //51
    public SmTbVipAccountBean[] loadByWhere(String where, int[] fieldList) throws SQLException
    {
        return loadByWhere(where, null, 1, -1);
    }

    /**
     * Retrieves an array of SmTbVipAccountBean given a sql where clause and a list of fields, and startRow and numRows.
     * It is up to you to pass the 'WHERE' in your where clausis.
     *
     * @param where the sql 'where' clause
     * @param startRow the start row to be used (first row = 1, last row = -1)
     ...
     */
    //51.5
    public SmTbVipAccountBean[] loadByWhere(String where, int[] fieldList, int startRow, int numRows) throws SQLException
    {
        String sql = null;
        if(fieldList == null)
            sql = "select " + ALL_FIELDS + " from sm_tb_vip_account " + where;
        else
        {
            ...
            buff.append(" from sm_tb_vip_account ");
            buff.append(where);
            sql = buff.toString();
            buff = null;
        }
        ...
        try
        {
            ...
            return (SmTbVipAccountBean[])v.toArray(new SmTbVipAccountBean[0]);
        }
        finally
        {
            if (v != null) { v.clear(); }
    ...
    /**
     * Deletes all rows from sm_tb_vip_account table.
     * @return the number of deleted rows.
     */
    ...
    /**
     * Deletes rows from the sm_tb_vip_account table using a 'where' clause.
     * It is up to you to pass the 'WHERE' in your where clausis.
    ...
    public int deleteByWhere(String where) throws SQLException
    {
        ...
        {
            c = getConnection();
            String delByWhereSQL = "DELETE FROM sm_tb_vip_account " + where;
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Saves the SmTbVipAccountBean pObject into the database.
     *
     * @param pObject the SmTbVipAccountBean pObject to be saved
     */
    //100
    public SmTbVipAccountBean save(SmTbVipAccountBean pObject) throws SQLException
    {
        ...
        try
        {
            ...
            { // SAVE
                ...
                int _dirtyCount = 0;
                _sql = new StringBuffer("INSERT into sm_tb_vip_account (");
            ...
            { // UPDATE
                ...
                _sql = new StringBuffer("UPDATE sm_tb_vip_account SET ");
                ...
                _sql.append(" WHERE ");
                _sql.append("sm_tb_vip_account.sm_vip_seq=?");
                ps = c.prepareStatement(_sql.toString(),ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                int _dirtyCount = 0;
    ...
    /**
     * Saves an array of SmTbVipAccountBean pObjects into the database.
     *
     * @param pObjects the SmTbVipAccountBean pObject table to be saved
     * @return the saved SmTbVipAccountBean array.
     */
    //65
    public SmTbVipAccountBean[] save(SmTbVipAccountBean[] pObjects) throws SQLException
    {
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Loads a unique SmTbVipAccountBean pObject from a template one giving a c
     *
     * @param pObject the SmTbVipAccountBean pObject to look for
     * @return the pObject matching the template
     */
    //85
    public SmTbVipAccountBean loadUniqueUsingTemplate(SmTbVipAccountBean pObject) throws SQLException
    {
         SmTbVipAccountBean[] pReturn = loadUsingTemplate(pObject);
         if (pReturn.length == 0)
             return null;
         if (pReturn.length > 1)
    ...
    /**
     * Loads an array of SmTbVipAccountBean from a template one.
     *
     * @param pObject the SmTbVipAccountBean template to look for
     * @return all the SmTbVipAccountBean matching the template
     */
    //88
    public SmTbVipAccountBean[] loadUsingTemplate(SmTbVipAccountBean pObject) throws SQLException
    {
        return loadUsingTemplate(pObject, 1, -1);
    }
    /**
     * Loads an array of SmTbVipAccountBean from a template one, given the start row and number of rows.
     *
     * @param pObject the SmTbVipAccountBean template to look for
     * @param startRow the start row to be used (first row = 1, last row=-1)
     * @param numRows the number of rows to be retrieved (all rows = a negative number)
     ...
     */
    //88.5
    public SmTbVipAccountBean[] loadUsingTemplate(SmTbVipAccountBean pObject, int startRow, int numRows) throws SQLException
    {
        Connection c = null;
        PreparedStatement ps = null;
        StringBuffer where = new StringBuffer("");
        StringBuffer _sql = new StringBuffer("SELECT " + ALL_FIELDS + " from sm_tb_vip_account WHERE ");
    ...
    /**
     * Deletes rows using a SmTbVipAccountBean template.
     *
     * @param pObject the SmTbVipAccountBean object(s) to be deleted
     * @return the number of deleted objects
     */
    //63
    public int deleteUsingTemplate(SmTbVipAccountBean pObject) throws SQLException
    {
        if (pObject.isSmVipSeqInitialized())
            return deleteByPrimaryKey(pObject.getSmVipSeq());
        ...
        try
        {
            sql = new StringBuffer("DELETE FROM sm_tb_vip_account WHERE ");
            int _dirtyAnd = 0;
            if (pObject.isSmVipSeqInitialized()) {
                if (_dirtyAnd > 0)
                    sql.append(" AND ");
    ...
    /**
     * Retrieves the number of rows of the table sm_tb_vip_account.
     *
    ...
    /**
     * Retrieves the number of rows of the table sm_tb_vip_account with a 'where' clause.
     * It is up to you to pass the 'WHERE' in your where clausis.
     *
    ...
    {
        String sql = "select count(*) as MCOUNT from sm_tb_vip_account " + where;
        Connection c = null;
        Statement pStatement = null;
        ResultSet rs =  null;
        try
    ...
    /**
     * Retrieves the number of rows of the table sm_tb_vip_account with a prepared statement.
     *
    ...
    /**
     * Looks for the number of elements of a specific SmTbVipAccountBean pObject given a c
     *
     * @param pObject the SmTbVipAccountBean pObject to look for
     * @return the number of rows returned
     */
    //83
    public int countUsingTemplate(SmTbVipAccountBean pObject) throws SQLException
    {
        StringBuffer where = new StringBuffer("");
        Connection c = null;
        PreparedStatement ps = null;
        ...
        try
        {
                _sql = new StringBuffer("SELECT count(*) as MCOUNT  from sm_tb_vip_account WHERE ");
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Transforms a ResultSet iterating on the sm_tb_vip_account on a SmTbVipAccountBean pObject.
     *
     * @param rs the ResultSet to be transformed
     * @return pObject resulting SmTbVipAccountBean pObject
     */
    //72
    public SmTbVipAccountBean decodeRow(ResultSet rs) throws SQLException
    {
        SmTbVipAccountBean pObject = createSmTbVipAccountBean();
        pObject.setSmVipSeq(Manager.getLong(rs, 1));
    ...
    /**
     * Transforms a ResultSet iterating on the sm_tb_vip_account table on a SmTbVipAccountBean pObject according to a list of fields.
     *
     * @param rs the ResultSet to be transformed
     * @param fieldList table of the field's associated constants
     * @return pObject resulting SmTbVipAccountBean pObject
     */
    //73
    public SmTbVipAccountBean decodeRow(ResultSet rs, int[] fieldList) throws SQLException
    {
        SmTbVipAccountBean pObject = createSmTbVipAccountBean();
        int pos = 0;
        for(int i = 0; i < fieldList.length; i++)
     ...
     *
     * @param ps the PreparedStatement to be used
     * @return an array of SmTbVipAccountBean
     */
    //41
    public SmTbVipAccountBean[] loadByPreparedStatement(PreparedStatement ps) throws SQLException
    {
     ...
     * @return an array of SmTbVipAccountBean
     */
    public SmTbVipAccountBean[] loadByPreparedStatement(PreparedStatement ps, int[] fieldList) throws SQLException
    {
     ...
     */
    //41.5
    public SmTbVipAccountBean[] loadByPreparedStatement(PreparedStatement ps, int[] fieldList, int startRow, int numRows) throws SQLException
    {
        ResultSet rs =  null;
        java.util.ArrayList v =  null;
        try
    ...
    // LISTENER
    ///////////////////////////////////////////////////////////////////////
    private SmTbVipAccountListener listener = null;

    /**
     * Registers a unique SmTbVipAccountListener listener.
     */
    //66.5
    public void registerListener(SmTbVipAccountListener listener) {
        this.listener = listener;
    }

    /**
     * Before the save of the SmTbVipAccountBean pObject.
     *
     * @param pObject the SmTbVipAccountBean pObject to be saved
     */
    //67
    void beforeInsert(SmTbVipAccountBean pObject) throws SQLException {
        if (listener != null)
            listener.beforeInsert(pObject);
    }

    /**
     * After the save of the SmTbVipAccountBean pObject.
     *
     * @param pObject the SmTbVipAccountBean pObject to be saved
     */
    //68
    void afterInsert(SmTbVipAccountBean pObject) throws SQLException {
        if (listener != null)
            listener.afterInsert(pObject);
    }

    /**
     * Before the update of the SmTbVipAccountBean pObject.
     *
     * @param pObject the SmTbVipAccountBean pObject to be updated
     */
    //69
    void beforeUpdate(SmTbVipAccountBean pObject) throws SQLException {
        if (listener != null)
            listener.beforeUpdate(pObject);
    }

    /**
     * After the update of the SmTbVipAccountBean pObject.
     *
     * @param pObject the SmTbVipAccountBean pObject to be updated
     */
    //70
    void afterUpdate(SmTbVipAccountBean pObject) throws SQLException {
        if (listener != null)
