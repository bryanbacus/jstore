 ...
 *   public class TestTool extends Utility{
 *   	static{
...
public class Tool {
	...
	public static String convertIpLongToString(long longIp) {
		String ipAddress = ((longIp >> 24) & 0xff) + "."
				+ ((longIp >> 16) & 0xff) + "." + ((longIp >> 8) & 0xff) + "."
				+ (longIp & 0xff);
		return ipAddress;
	}
	 ...
	 * It will return "取Integer Properties失敗:" + name.
	 * </pre>
	 * @param name
	 * @return
	 */
	public static int getIntProperty(String name) {		
		try {
			...
			System.out.println("取Integer Properties失敗:" + name);
			return 0;
		}
	}
	 ...
	 * <pre>
	 * If the property file not exist or the name not define.
	 * It will return "取String Properties失敗:" + name.
	 * </pre>
	 * 
	 * @param name
	 * @return
	...
	public static String getStringProperty(String name) {
		try {
			...
			System.out.println("取String Properties失敗:" + name);
			return null;
		}
	}
	...
	public static HashMap<String, String> getMapProperty(String forname) {
		...
		try {
			...
			while (em.hasMoreElements()) {
				...
				if (str.length() > forname.length()
						&& str.substring(0, forname.length()).equals(forname)) {
					hm.put(str.substring(forname.length() + 1, str.length()),
							rb.getString(str));
				}
			}
			return hm;
	...
	public static void logDebug(String msg) {
		if (Tool.isDebug())
			System.out.println("[" + Tool.getToday("yyyy/MM/dd HH:mm:ss") + "]"
					+ msg);
	}
	...
	public static void logError(String msg) {
		if (Tool.isDebug())
			System.err.println("[" + Tool.getToday("yyyy/MM/dd HH:mm:ss") + "][ERROR]"
					+ msg);
	}
...
//				Object obj = map.get(key);
//				if(obj instanceof String){
//					newMap.put(key, new String(((String)obj).getBytes("BIG5"), "iso-8859-1"));
//				}
//			}
//			
//			map.putAll(newMap);
...
//				Object obj = map.get(key);
//				if(obj instanceof String){
//					newMap.put(key, new String(((String)obj).getBytes("iso-8859-1"),"BIG5" ));
//				}
//			}
//			
//			map.putAll(newMap);
