...
<form name="zipForm" method="post">
	...
	<tr>
		<td>
			<font color="#666666">郵遞區號</font>
			<input name="zipcode" size=5 readonly="readonly" onfocus="alert('郵遞區號會自動產生');zipForm.zipcode.blur(); " style="border:none;">
	...
	<tr>
		<td align="center">
			...
			<input name="submit" type="button" value="確定" onClick='ok2(zipForm.zipcode,zipForm.address)'>
			<input name="close" type="button" value="關閉" onClick='window.close()' >
		</td>
	</tr>
...
//		window.close();
	...
	function ok2(post,address)		{	
		...
		//alert("您的郵遞區號是"+post.value+" !");
  		//window.close();
	  	alert("您的郵遞區號是"+post.value+"，地址："+ address.value);
